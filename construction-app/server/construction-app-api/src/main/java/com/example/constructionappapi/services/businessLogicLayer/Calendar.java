...
public class Calendar {
    ...
    public Calendar() {
        WorkEntity door = new WorkEntity(1, "Door", LocalDate.of(2023, 5, 22), 10, "testNote", null, Status.NOTSTARTED, null, new ArrayList<>());
        WorkEntity fence = new WorkEntity(2, "Fence", LocalDate.of(2023, 5, 25), 10, "testNote", null, Status.NOTSTARTED, null, new ArrayList<>());
        WorkEntity roof = new WorkEntity(3, "Roof", LocalDate.of(2023, 5, 29), 2, "testNote", null, Status.NOTSTARTED, null, new ArrayList<>());
    ...
    public void printCalendar() {
        calendarDates.keySet().stream().sorted(Comparator.reverseOrder()).forEach(key -> {
            ...
            String s = String.format("Key: %s %-10s %s | Value: %-6s %s %s", key.getDate(), key.getDate().getDayOfWeek(), key.hashCode(), work.getName(), work.getStartDate(), work.getNumberOfDays());
