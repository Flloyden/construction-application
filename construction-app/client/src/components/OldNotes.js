...
export default function OldNotes(props) {
  ...
  if (notes.length < 1) {
    ...
    return (
      <div>
        {!loading && (
        <table className="w-full text-sm text-left bg-white opacity-60 dark:bg-gray-800 text-gray-00 shadow-md rounded mt-4">
              ...
              return (
                ...
                >
                  ...
                  <td className="flex justify-around py-2 items-end">
                    ...
                    {/** Ny komponent för summerade anteckningar om ett specifikt jobb */}
                    </div>
                  </td>
                </tr>
              );
